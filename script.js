...
(function () {
    ...
    var styling = ".oo-btn{box-sizing:border-box;border-radius: 10px;display:flex;flex-direction:row;justify-content:center;align-items:center;padding:8px 20px;gap:10px;width:fit-content;height:40px;left:20px;top:20px;text-decoration:none;font-style:normal;font-size:16px;line-height:20px}a.oo-btn{text-decoration:none;}.oo-btn.light{background:#e9edef;border:1px solid #a2a9af;color:#303030}.oo-btn.light:hover{background:#fbfeff}.oo-btn.light:active{background:#ddeff8}.oo-btn.dark{background:#00202e;color:#fff}.oo-btn.dark:hover{background:#003b53}.oo-btn.dark:active{background:#015273}"
